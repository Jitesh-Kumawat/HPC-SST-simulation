...
# Job 1: Allreduce on 2 ranks
# This job will use global ranks 0, 1
num_mpi_ranks_job1 = 2
...
# Job 2: Alltoall on 2 ranks 
# This job will use global ranks 2, 3 (after Job 1's ranks)
num_mpi_ranks_job2 = 2
ep2 = EmberMPIJob(2, num_mpi_ranks_job2) 
...
sst.setStatisticOutputOptions({
    "filepath": "mesh_multi_job_stats.csv",
    "separator": ", "
})
